...
class ClashRuleProviderMiu(_PluginBase):
    # 插件名称
    plugin_name = "Clash Rule Provider Miu"
    # 插件描述
    plugin_desc = "随时为Clash添加一些额外的规则。基于 wumode 的插件修改。"
    # 插件图标
    plugin_icon = "Mihomo_Meta_A.png"
    # 插件版本
    plugin_version = "2.1.5.1"
    # 插件作者
    plugin_author = "wumode,Miu"
    # 作者主页
    author_url = "https://github.com/wumode"
    # 插件配置项ID前缀
    plugin_config_prefix = "clashruleprovidermiu_"
    # 加载顺序
    plugin_order = 99
    # 可使用的用户级别
    auth_level = 1
